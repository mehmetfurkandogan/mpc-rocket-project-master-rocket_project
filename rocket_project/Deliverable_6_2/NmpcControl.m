classdef NmpcControl < handle
    ...
    methods
        function obj = NmpcControl(rocket, tf, expected_delay)
            ...
            Q = diag([10 10 10 1 1 200 10 10 10 1000 1000 1000]);
            R = 0.01*eye(nu);
            ...
            %Create Ref
            X_ref = [SX.zeros(1, 5) ref_sym(4) SX.zeros(1, 3) ref_sym(1:3)']';
            U_ref = [SX.zeros(1, 4)]';
            ...
            % Terminal Cost
            cost = (X_sym(:, N) - X_ref)'*P*(X_sym(:, N) - X_ref);
        ...
        function [u, T_opt, X_opt, U_opt] = get_u(obj, x0, ref)
            ...
            for i = 1:delay
                x_ = x_ + obj.rocket.f(x_, mem_u(:, i))*obj.rocket.Ts;
            end
